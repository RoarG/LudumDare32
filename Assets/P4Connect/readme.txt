...
-------------
Version 2.7
- Provide both 32bit and 64bit support in a single package (Windows only), no Unity 5 yet...
- Updated Perforce P4API.net to 2014.2 release
- Added p4config.ini file to persist project specific settings.
...
-------------
Version 2.5
- Initial release by Perforce Software
